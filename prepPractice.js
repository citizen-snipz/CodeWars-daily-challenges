//create function with word that determines if the word is a palindrome
// write function that takes a string
// reverse string
// check if the original and reverse string match exactly
// return boolean
...
// console.log(isPalindrome("shara"))
